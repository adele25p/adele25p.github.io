...
Document transversal : présente les idées d'évolutions futures, les questions encore ouvertes et les notes diverses du projet.

**Version** : v1.0

## 1. Évolutions futures / Idées à explorer
...
assets/inspiration/clair.jpg et assets/inspiration/sombre.jpg
